...
public class OverviewFragment extends Fragment implements OnRecipeInsertListener {
    ...
    @BindView(R.id.text_edit_title) TextInputEditText mTitleView;
    @BindView(R.id.text_edit_servings) TextInputEditText mServingsView;
    @BindView(R.id.text_edit_prep_time) TextInputEditText mPrepTimeView;
    @BindView(R.id.text_edit_cook_time) TextInputEditText mCookTimeView;

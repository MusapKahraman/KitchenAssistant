...
public class StorageAdapter extends RecyclerView.Adapter<StorageAdapter.FoodViewHolder> {
    private final OnFoodClickListener mOnFoodClickListener;
    ...
    public StorageAdapter(Context context, OnFoodClickListener onFoodClickListener) {
        mContext = context;
    ...
    public void filter(CharSequence charSequence) {
        ...
        if (!charString.isEmpty()) {
            ...
            for (Food row : mFoods) {
                if (row.food.toLowerCase().contains(charString.toLowerCase())) {
    ...
    class FoodViewHolder extends RecyclerView.ViewHolder {
        ...
        private void bind(int position) {
            ...
            foodTextView.setText(current.food);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (mMultiSelect) {
                        ...
                        mOnFoodClickListener.onFoodClick(current);
                    }
                }
            });

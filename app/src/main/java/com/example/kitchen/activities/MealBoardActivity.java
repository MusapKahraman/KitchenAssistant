...
public class MealBoardActivity extends AppCompatActivity
    ...
    private void changeContent() {
        ...
        switch (mNavigatorIndex) {
            ...
            case 1:
                ...
                Log.v("MealBoardActivity", "Navigator Index: " + mNavigatorIndex);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.meal_board, menu);
        return true;
    }
                ...
                AuthUI.getInstance()
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                Intent intent = new Intent(MealBoardActivity.this, LoginActivity.class);
